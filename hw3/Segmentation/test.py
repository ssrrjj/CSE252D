...
parser.add_argument('--fileList', default='/datasets/cs252-sp21-A00-public/hw3_data/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt', help='path to input images' )
